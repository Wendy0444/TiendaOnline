        ...
        <div class="col-lg-12">
            <h1 class="page-header">Proveedores
				<span class="pull-right">
					<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addsupplier"><i class="fa fa-plus-circle"></i> Agregar Proveedor</button>
				</span>
			</h1>
        </div>
    </div>
					...
					?>
						<tr>
							...
							<td>
								...
								<button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#del_<?php echo $sqrow['userid']; ?>"><i class="fa fa-trash"></i> Eliminar</button>
