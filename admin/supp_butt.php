        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <center><h4 class="modal-title" id="myModalLabel">¿Seguro que quieres Eliminar el proveedor?</h4></center>
                </div>
				...
				<div class="container-fluid">
					...
					?>
                    <h5><center>Nombre de la compañia: <strong><?php echo ucwords($b['company_name']); ?></strong></center></h5>
