        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <center><h4 class="modal-title" id="myModalLabel">¿Seguro que quieres Eliminar el producto?</h4></center>
                </div>
            ...
            <div class="modal-content">
				...
				<div class="container-fluid">
                    ...
                    <form role="form" method="POST" action="edit_product.php<?php echo '?id='.$pid; ?>" enctype="multipart/form-data">
						...
						<div style="height:10px;"></div>					
						<div class="form-group input-group">
                            <span class="input-group-addon" style="width:120px;">Imagen:</span>
