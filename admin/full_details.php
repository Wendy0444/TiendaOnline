        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
					...
					<center><h4 class="modal-title" id="myModalLabel">Detalles Completos</h4></center>
                </div>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12">
							...
							<span class="pull-right">Fecha de Venta: <strong><?php echo date("F d, Y", strtotime($srow['sales_date'])); ?></strong></span>
						</div>
					</div>
